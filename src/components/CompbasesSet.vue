<template>
	<div id="basesSetInfo">
		<div id="inbound" class="wzborder"><span class="wzborder_mtitle">本地代理</span>
		...
		<div id='idBsetdns' class='wzborder'><span class='mtitle'>DNS</span>
			<p><b class="infoname">DNS</b><textarea name='dns' placeholder='8.8.8.8,1.1.1.1' v-model="dns" class="infoinput"></textarea></p>
		</div>
		<div id="idlogset" class="wzborder"><span class="wzborder_mtitle">log 日志</span>
		...
		<div id="idsubset" class="wzborder"><span class="wzborder_mtitle">订阅相关设置</span>
			...
			<p><input type="checkbox" name="isRandsub" v-model="evset.isRandsub"><span>是否随机</span>
				<p class="tip">* 一些免费订阅链接可能包含上百个服务器，根本用不了那么多，还占位置，选择起来也麻烦。</p>
		</div>
		<div id="idevset" class="wzborder csevset"><span class="wzborder_mtitle">本程序相关</span>
