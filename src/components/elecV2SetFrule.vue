...
<div>
  ...
  <div>
    <textarea class="infoinput rulescont" v-model="strrules"></textarea>
  </div>
  <div class="ruleresults">
    <b class="infoname">测试结果</b><input class="infoinput" v-model="ruleresults"><span class="ruleresults ruleresults_span">{{ ruleres() }}</span>
    <p class="tip">*测试结果仅供参考，实际结果根据 "进阶设置中的出站及路由优先级" 有所不同。</p>
  </div>
</div>
</template>
...
.ruleresults .infoinput { width: 256px;margin-top: 20px }
.ruleresults .ruleresults_span { margin-left: 40px }
</style>