<template>
<li>
  <h3><big class="sername infoname">名字</big><input class="infoinput infoinput_middle" name='name' type='text' :placeholder='serjson.id' v-model='serjson.name'></h3>
  <div class='info wzborder'>
    ...
    <div v-if="serjson.protocol=='vmess'">
      ...
      <p><b class="infoname">alterId</b><input name="aid" placeholder="4" v-model='serjson.aid' class="infoinput infoinput_two"><b class="infoname">path</b><input name='path' v-model='serjson.path' class="infoinput infoinput_two"></p>
    </div>
    <div v-else>
