...
<div class="advanSetInfo">
  ...
  <div class="wzborder cskcpset"><span class="wzborder_mtitle">KCP参数设置</span>
    ...
    <p><b class="infoname">rBSize</b><input name='readBufferSize' v-model='outBset.kcp[5]' placeholder='读缓 MB' class="infoinput infoinput_two"><b class="infoname">wBSize</b><input name='writeBufferSize' v-model='outBset.kcp[6]' placeholder='写缓 MB' class="infoinput infoinput_two"></p>
  </div>
